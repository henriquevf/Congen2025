...
We will now convert  
![Screenshot 2025-01-08 110508](https://github.com/user-attachments/assets/cbc6a42d-5713-4daa-af84-12e556098bb1)
...
ggplot(summarized_data, aes(x = generation_interval, y = total_RoH_length, color = sample_color, group = Sample)) +
