...
###  Our dataset 
We will be using a VCF of xxx elephant individuals, which include xxx African Savannah Elephants and xxx African Forest Elephants. This amount of indivdiuals will allow us to investigate the population structure of elephants in Africa at a fine-scale. 
...
VCF=/anvil/scratch/x-hfigueiro/LoxAfr4_elephant_no1stdegree_variable_sites_nomultiallelics_noindels_10dp_3het_chr1.vcf.gz
OUT=/anvil/scratch/x-hfigueiro/LoxAfr4_elephant_no1stdegree_variable_sites_nomultiallelics_noindels_10dp_3het_chr1_minQ30_noindels_maxmissing0.8
