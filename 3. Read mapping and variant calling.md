...
#SBATCH -o /anvil/scratch/YOUR_USERNAME/log/03_GATK_HaplotypeCaller.o%j
#SBATCH -e /anvil/scratch/YOUR_USERNAME/log/03_GATK_HaplotypeCaller.e%j
...
-R ${REF} \
-ERC GVCF \
-O /anvil/scratch/x-YOURNAME/03_readmapping_variantcalling/NA5206.loxAfr4_NC000934_subsampled
```
