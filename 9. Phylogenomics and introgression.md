...
output_file <- paste0(output_dir, "phylo_tree_plot.png") # Define the output file path
...
OUTPUT_FOLDER="/anvil/scratch/x-larantes/09_phylogenomic_introgression"
OUTPUT_PREFIX="elephant.phy"
PHYLIP_FILE="/anvil/scratch/x-larantes/09_phylogenomic_introgression/elephant.phy.min4.phy"
